...
from sdf.farmbios.storage_handler import StorageRPCHandler
...
from sdf.waterguard.waterguard_storage import WaterGuardStorage 
...
if __name__ == "__main__":
    ...
    try:
        with open(config_file_path, 'r') as fd:
            ...
            config = WaterGuardStorageConfig(config)
